  ...
  return (
    <Navbar bg="light" expand={false} className="navbarCA">
      <Container className="navbarContent">
        ...
        {/* FIXME: corrigir esse canvas com valor corretos e estilizar melhor... */}
        <Navbar.Offcanvas
          id="offcanvasNavbar"
        ...
        >
          ...
          <Offcanvas.Body>
            <Nav className="justify-content-end flex-grow-1 pe-3">
              <Nav.Link href="/cart"><button>Abrir carrinho</button></Nav.Link>
              <Nav.Link href="#action2">Informações e Endereço</Nav.Link>
              <Nav.Link href="#action2">Horário de atendimento</Nav.Link>
              <Nav.Link href="#action2">Ligar para a empresa</Nav.Link>
              <Nav.Link href="#action2">Enviar mensagem</Nav.Link>
            </Nav>
          </Offcanvas.Body>
        </Navbar.Offcanvas>
      </Container>
